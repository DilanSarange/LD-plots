setwd("I:/Quinoa/Results/SNP_Calling_V2/Final_data_analysis/LD_decay")
...
ggplot() +geom_line(data = both_genomes,aes(x=Bin,y=LD,colour=Genome),size=1.5,alpha=1)+
...
Cq1A<-read.table("LD_DECAY_plots_01_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq2A<-read.table("LD_DECAY_plots_02_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq3A<-read.table("LD_DECAY_plots_03_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq4A<-read.table("LD_DECAY_plots_04_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq5A<-read.table("LD_DECAY_plots_05_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq6A<-read.table("LD_DECAY_plots_06_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq7A<-read.table("LD_DECAY_plots_07_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq8A<-read.table("LD_DECAY_plots_08_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq9A<-read.table("LD_DECAY_plots_09_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq1B<-read.table("LD_DECAY_plots_10_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq2B<-read.table("LD_DECAY_plots_11_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq3B<-read.table("LD_DECAY_plots_12_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq4B<-read.table("LD_DECAY_plots_13_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq5B<-read.table("LD_DECAY_plots_14_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq6B<-read.table("LD_DECAY_plots_15_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq7B<-read.table("LD_DECAY_plots_16_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq8B<-read.table("LD_DECAY_plots_17_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
Cq9B<-read.table("LD_DECAY_plots_18_chr_maxmiss0.5_minDP5_maf0.05.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
genome_A_Chr<-rbind(Cq1B,Cq2A,Cq3A,Cq4A,Cq5A,Cq6A,Cq7A,Cq8A,Cq9A)

ggplot()+ geom_line(data = genome_A_Chr,aes(x=Bin,y=LD,colour=Chromosome),size=1,alpha=1)+labs(x="Pairwise distance (kb)",y=expression(LD~(r^{2})))+
...
ggplot()+ geom_line(data = genome_B_Chr,aes(x=Bin,y=LD,colour=Chromosome),size=1,alpha=1)+labs(x="Pairwise distance (kb)",y=expression(LD~(r^{2})))+
  scale_x_continuous(breaks=c(0,50*10^3,100*10^3,150*10^3,200*10^3,250*10^3),labels=c("0","50","100","150","200","250"))+theme_classic()+
  theme(legend.position=c(0.8,0.6),axis.text=element_text(size=12),axis.title=element_text(size=14))+
  scale_color_manual(values=c('#003366','#CC0033',"#66CC00","#66CCFF","#FF9933","#FF9900","#330033","#CC33CC","#FF66CC","#CC6600","#33FF33"))+
  geom_hline(yintercept=0.2, linetype="dashed", 
             color = "black", size=0.5)
...
low<-read.table("LD_DECAY_plots_lowland_maxmiss0.5_minDP5_maf0.05.ANNOTATED.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")
...
high<-read.table("LD_DECAY_plots_highland_quinoa_snps_maxmiss0.5_minDP5_maf0.05.ANNOTATED.recode.vcf.gz_LD_decay.stat.gz.bin",header = F,sep = "\t")

head(high)

high<-replace(high ,"Population","Higland")
...
ggplot()+ geom_line(data = highland_lowland,aes(x=Bin,y=LD,colour=Population),size=1,alpha=1)+labs(x="Pairwise distance (kb)",y=expression(LD~(r^{2})))+
  ...
  theme(legend.position=c(0.8,0.6),axis.text=element_text(size=12),axis.title=element_text(size=14))+
  scale_color_manual(values=c('#003366','#CC0033',"black"))+
  geom_hline(yintercept=c(0.2,0.1), linetype="dashed", 
             color = "black", size=0.5)+
  ylim(0,0.8)
